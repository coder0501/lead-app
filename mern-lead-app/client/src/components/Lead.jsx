...
const Lead = () => {
  ...
  const fetchLeads = async () => {
    try {
      const res = await axios.get("https://lead-app-rhu2.vercel.app/leads");
      setLeads(res.data);
    } catch (error) {
  ...
  const handleSearch = async () => {
    if (search.trim() === "") {
      ...
      try {
        const res = await axios.get(`https://lead-app-rhu2.vercel.app/leads?search=${search}`);
        setLeads(res.data);
      } catch (error) {
  ...
  const handleSort = async (sortField) => {
    setSort(sortField);
    try {
      const res = await axios.get(`https://lead-app-rhu2.vercel.app/leads?sort=${sortField}`);
      setLeads(res.data);
    } catch (error) {
  ...
  const handleCreateLead = async () => {
    try {
      await axios.post("https://lead-app-rhu2.vercel.app/leads", leadData);
      fetchLeads();
  ...
  const handleUpdateLead = async (id) => {
    try {
      await axios.put(`https://lead-app-rhu2.vercel.app/leads/${id}`, editingLeadData);
  ...
  const handleDeleteLead = async (id) => {
    try {
      await axios.delete(`https://lead-app-rhu2.vercel.app/leads/${id}`);
      fetchLeads();
    } catch (error) {
